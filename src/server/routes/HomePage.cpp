...
/**
 * ------------------------------------------------------------------------
 * The route for serving the homepage
 *
 ...
 * ------------------------------------------------------------------------
 */
int Route_HomePage(int socket, Request* request)
{
    ...
    char* file = 0;
    char FILE_INDEX[] = "./resources/homepage/index.html";
    char FILE_STYLE[] = "./resources/homepage/style.css";
    char FILE_MAIN[] = "./resources/homepage/main.js";
    ...
    else if (strcmp(request->path, "/main.js") == 0) {
        file = &(FILE_MAIN[0]);
    }
    else {
