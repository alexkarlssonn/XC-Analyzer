...
#define API_ATHLETE_FISCODE 2
#define API_ATHLETES_FIRSTNAME 3
#define API_ATHLETES_LASTNAME 4
#define API_ATHLETES_FULLNAME 5
#define API_RACEIDS_FISCODE 6
#define API_RACEINFO_RACEID 7
#define API_RACERESULTS_RACEID 8
#define API_ANALYZE_QUAL_FISCODE 9
